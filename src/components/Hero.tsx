  ...
  return (
    <section className="relative h-screen w-full flex flex-col justify-between p-8 md:p-16 overflow-hidden bg-main-bg transition-colors duration-500">
      ...
      >
        ...
        {/* Lighter Gradient Overlay for better text separation without crushing blacks */}
        <div className="absolute inset-0 bg-gradient-to-b from-main-bg/20 via-transparent to-main-bg/40 pointer-events-none" />
      </motion.div>

      {/* 1. TOP STATUS BAR */}
      <div className="relative z-20 pt-4 md:pt-8 flex justify-between items-start font-mono text-xs tracking-[0.3em] text-main-text/80 uppercase">
        <motion.div 
      ...
      >
        <span className="font-mono text-[11px] uppercase tracking-[0.6em] [writing-mode:vertical-rl] text-main-text font-bold">
          Next_Module
        </span>
      ...
      <div className="relative z-20 flex flex-col md:flex-row md:items-end justify-between gap-10">
        ...
        >
          ...
          <h1 className="font-gaming text-6xl md:text-8xl font-light leading-none uppercase tracking-tighter text-main-text italic mb-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <p className="max-w-md font-mono text-[13px] text-main-text font-bold leading-relaxed uppercase tracking-[0.2em]">
        ...
        >
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            className="group relative border-r-[6px] border-brand bg-main-text text-main-bg px-12 py-5 font-gaming font-black uppercase italic text-2xl transition-all hover:bg-brand hover:text-white shadow-[10px_10px_0px_var(--tactical-border)]"
          >
            Engage_Now
          </motion.button>
        </motion.div>
