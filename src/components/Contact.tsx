 ...
 * Optimized for mobile with tactical UI enhancements and responsive scaling.
 */
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            <div className="inline-flex items-center gap-4">
              ...
              <span className="font-mono text-[10px] md:text-xs tracking-[0.3em] md:tracking-[0.5em] text-brand uppercase italic animate-pulse font-bold">
            ...
            <div className="pt-2 md:pt-4 space-y-6">
              ...
              >
                <p className="font-mono text-[10px] md:text-xs text-brand mb-1 md:mb-2 transition-all group-hover:tracking-widest font-bold">// COMM_LINK</p>
          ...
          <motion.div 
            ...
            className="relative"
          >
            {/* HUD Corner Brackets - Responsive positioning */}
            ...
            <form className="bg-card backdrop-blur-xl border border-tactical-border p-6 md:p-12 space-y-6 md:space-y-8 relative overflow-hidden">
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="group relative w-full h-12 md:h-14 bg-transparent border border-brand/50 flex items-center justify-center overflow-hidden transition-all hover:border-brand"
              >
